...
<?php 
    ...
    $user =mysqli_fetch_assoc(mysqli_query($conn,"SELECT * from userdata where userid=$userid"));
    include 'submit.php';
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="Status_Pendaftaran.php"><i class="ti-layout"></i><span>Status Pendaftaran</span></a>
                            </li>
                            <li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8 col-sm-4 clearfix">
                        <ul class="notification-area pull-right">
                            <li><h5>Nama Sedang login :  <?= $user["namalengkap"] ?></h5></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 Selamat datang di sistem informasi Penerimaan Peserta Didik Baru (PSB) Online.
...
<!------------------ Pisahin ------------------->
        ...
        <footer>
            <div class="footer-area">
                <p>FAHMI NUR BAIHAQI 18104032</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
